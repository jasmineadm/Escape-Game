...
public class Zone {
	...
	public static Zone[] initZones() {
	    ...
	    zones[4] = new Zone("le Ponton1", new Objet[] { new Objet("le bateau", "contient la carte et le portable qui te permettront de localiser le sac") });
	    zones[5] = new Zone("le Ponton2", new Objet[] { new Objet("le bateau", "contient la carte et le portable qui te permettront de localiser le sac")});
	    zones[6] = new Zone("le Ponton3", new Objet[] { new Objet("le bateau", "contient la carte et le portable qui te permettront de localiser le sac") });
